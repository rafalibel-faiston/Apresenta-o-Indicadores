...
interface FaistonLogoProps {
  className?: string;
  width?: string | number;
  height?: string | number;
}

export default function FaistonLogo({ className = "", width = "220", height = "130" }: FaistonLogoProps) {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width={width} 
      height={height} 
      viewBox="-0.15 0 334.1 84.29"
      className={className}
    >
      <defs>
        <linearGradient id="e" x1="2.55" x2="14.67" y1="62.94" y2="83.92" gradientUnits="userSpaceOnUse">
          <stop stopColor="#00029c" offset=".09" />
          <stop stopColor="#038cc9" offset=".53" />
          <stop stopColor="#05e2e5" offset=".8" />
        </linearGradient>
        <linearGradient id="a" x1="75.3" x2="19.26" y1="56.42" y2="56.42" gradientUnits="userSpaceOnUse">
          <stop stopColor="#00fafb" offset=".18" />
          <stop stopColor="#00ebfa" offset=".24" />
          <stop stopColor="#00c5f6" offset=".36" />
          <stop stopColor="#0087f1" offset=".52" />
          <stop stopColor="#0054ec" offset=".65" />
          <stop stopColor="#2226c0" offset="1" />
        </linearGradient>
        <linearGradient id="f" x1="3351.2" x2="3297.6" y1="-2879" y2="-2879" gradientTransform="translate(-1273.9 4218.5) rotate(-31.91)" gradientUnits="userSpaceOnUse">
          <stop stopColor="#fd5665" offset=".16" />
          <stop stopColor="#fd11a4" offset=".58" />
          <stop stopColor="#f110a3" offset=".62" />
          <stop stopColor="#c00d9f" offset=".79" />
          <stop stopColor="#a10b9d" offset=".93" />
          <stop stopColor="#960a9c" offset="1" />
        </linearGradient>
